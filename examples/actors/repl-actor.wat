(module
  ...
  (import "wisp:evaluator" "eval-request" (func $__raw_eval-request (param i32 i32 i32 i32) (result i32)))
  ...
  (func $eval-request (param $params i32) (result i32)
    (local $in_buf i32)
    (local $in_len i32)
    (local $out_ptr i32)
    (local $out_len i32)
